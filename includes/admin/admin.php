...
function bp_wcv_screen_function()
{
    ...
    $tabs = array(
        ...
        'links'     => 'Deactivate Links',
        'redirects' => 'Redirects',
        'signup'    => 'Sign up Forms',
        'go_pro'    => '<font color="#b22222">Go Professional!!!</font>',
    );
                ...
                ?>
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    <?php 
                bp_wcv_disabled_message();
                ?>

	                                <?php 
                ( isset( $bp_wcv_options['general']['tab_settings_disabled'] ) ? $tab_settings_disabled = $bp_wcv_options['general']['tab_settings_disabled'] : ($tab_settings_disabled = 0) );
                ?>
                                    <p <?php 
                bp_wcv_pro();
                ?>><input <?php 
                bp_wcv_disabled();
                ?> name='bp_wcv_options[general][tab_settings_disabled]' type='checkbox' value='1' <?php 
                checked( $tab_settings_disabled, 1 );
                ?> /> <b>Turn off "Settings" tab </b>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
	                                ...
	                                <?php 
                $tab_orders_disabled = ( isset( $bp_wcv_options['general']['tab_orders_disabled'] ) ? $bp_wcv_options['general']['tab_orders_disabled'] : 0 );
                ?>
                                    <p <?php 
                bp_wcv_pro();
                ?>><input name='bp_wcv_options[general][tab_orders_disabled]' type='checkbox' <?php 
                bp_wcv_disabled();
                ?> value='1' <?php 
                checked( $tab_orders_disabled, 1 );
                ?> />
                                        <b>Turn off "Orders" tab </b>
                                    </p>

									<?php 
                $tab_products_disabled = ( isset( $bp_wcv_options['general']['tab_products_disabled'] ) ? $bp_wcv_options['general']['tab_products_disabled'] : 0 );
                ?>
                                    <p <?php 
                bp_wcv_pro();
                ?>><input name='bp_wcv_options[general][tab_products_disabled]' type='checkbox' <?php 
                bp_wcv_disabled();
                ?> value='1' <?php 
                checked( $tab_products_disabled, 1 );
                ?> />
                                        <b>Turn off "Products" tab </b>
                                    </p>

									<?php 
                $tab_ratings_disabled = ( isset( $bp_wcv_options['general']['tab_ratings_disabled'] ) ? $bp_wcv_options['general']['tab_ratings_disabled'] : 0 );
                ?>
                                    <p <?php 
                bp_wcv_pro();
                ?>><input name='bp_wcv_options[general][tab_ratings_disabled]' type='checkbox' <?php 
                bp_wcv_disabled();
                ?> value='1' <?php 
                checked( $tab_ratings_disabled, 1 );
                ?> />
                                        <b>Turn off "Ratings" tab </b>
                                    </p>

									<?php 
                $tab_coupons_disabled = ( isset( $bp_wcv_options['general']['tab_coupons_disabled'] ) ? $bp_wcv_options['general']['tab_coupons_disabled'] : 0 );
                ?>
                                    <p <?php 
                bp_wcv_pro();
                ?>><input name='bp_wcv_options[general][tab_coupons_disabled]' type='checkbox' <?php 
                bp_wcv_disabled();
                ?> value='1' <?php 
                checked( $tab_coupons_disabled, 1 );
                ?> />
            ...
            case 'roles':
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
	                                   ...
	                                   <?php 
                $vendor_role = ( isset( $bp_wcv_options['roles']['vendor'] ) ? $bp_wcv_options['roles']['vendor'] : 0 );
                ?>
                                    <p><input name='bp_wcv_options[roles][vendor]' type='checkbox'
                                              value='1' <?php 
                checked( $vendor_role, 1 );
                ?> /> Create new Member Type "Vendor" for all Vendors </p>

	                                <?php 
                $vendor_directory = ( isset( $bp_wcv_options['roles']['vendor_directory'] ) ? $bp_wcv_options['roles']['vendor_directory'] : 0 );
                ?>
                                    <p <?php 
                bp_wcv_pro();
                ?>><input name='bp_wcv_options[roles][vendor_directory]' type='checkbox' <?php 
                bp_wcv_disabled();
                ?>
                                              value='1' <?php 
                checked( $vendor_directory, 1 );
                ?> /> Create a "Vendor Directory" </p>

	                                <?php 
                $vendor_directory_name = ( isset( $bp_wcv_options['roles']['vendor_name'] ) ? $bp_wcv_options['roles']['vendor_directory_name'] : __( 'Vendors', 'bpwcv' ) );
                ?>
                                    <p <?php 
                bp_wcv_pro();
                ?>><label>Directory Name: </label><input name='bp_wcv_options[roles][vendor_directory_name]' type='text' <?php 
                bp_wcv_disabled();
                ?>
                                              value='<?php 
                echo  $vendor_directory_name ;
                ?>' /></p>

	                                <?php 
                $vendor_directory_name_singular = ( isset( $bp_wcv_options['roles']['vendor_name_singular'] ) ? $bp_wcv_options['roles']['vendor_directory_name_singular'] : __( 'Vendor', 'bpwcv' ) );
                ?>
                                    <p <?php 
                bp_wcv_pro();
                ?>><label>Directory Name Singular: </label><input name='bp_wcv_options[roles][vendor_directory_name_singular]' type='text' <?php 
                bp_wcv_disabled();
                ?>
                                              value='<?php 
                echo  $vendor_directory_name_singular ;
                ?>' /></p>
                ...
                foreach ( $member_types as $member_type ) {
                    ...
                    ?>
                                        <p <?php 
                    bp_wcv_pro();
                    ?>><input name='bp_wcv_options[roles][member_types][<?php 
                    echo  $member_type ;
                    ?>]' type='checkbox' <?php 
                    bp_wcv_disabled();
                    ?>
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
									...
									<?php 
                $visit_store_disabled = ( isset( $bp_wcv_options['links']['visit_store_disabled'] ) ? $bp_wcv_options['links']['visit_store_disabled'] : 0 );
                ?>
                                    <p><input name='bp_wcv_options[links][visit_store_disabled]' type='checkbox'
                                              value='1' <?php 
                checked( $visit_store_disabled, 1 );
                ?> /> <b>Disable
                                            "Visit
                                            Store" Link</b></p>
                                    <br>
                                    <p>Deactivate the "Profile Links" in the Vendor Shop Product listings and Products
                                        ...
                                        Views</p>
									<?php 
                $view_profile_disabled = ( isset( $bp_wcv_options['links']['view_profile_disabled'] ) ? $bp_wcv_options['links']['view_profile_disabled'] : 0 );
                ?>
                                    <p><input name='bp_wcv_options[links][view_profile_disabled]' type='checkbox'
                                              value='1' <?php 
                checked( $view_profile_disabled, 1 );
                ?> /> <b>Disable
                                            "View
                                            Profile" Link</b></p>
                                    <br>
									...
									<?php 
                $sold_by_disabled = ( isset( $bp_wcv_options['links']['sold_by_disabled'] ) ? $bp_wcv_options['links']['sold_by_disabled'] : 0 );
                ?>
                                    <p><input name='bp_wcv_options[links][sold_by_disabled]' type='checkbox'
                                              value='1' <?php 
                checked( $sold_by_disabled, 1 );
                ?> /> <b>Disable "Sold
                                            by"
                                            Link</b></p>
                                    <br>
									...
									<?php 
                $contact_vendor_disabled = ( isset( $bp_wcv_options['links']['contact_vendor_disabled'] ) ? $bp_wcv_options['links']['contact_vendor_disabled'] : 0 );
                ?>
                                    <p><input name='bp_wcv_options[links][contact_vendor_disabled]' type='checkbox'
                                              value='1' <?php 
                checked( $contact_vendor_disabled, 1 );
                ?> /> <b>Disable
                                            "Contact
                                            Vendor" Link</b></p>
                                    <br>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>
                                        <br>
										<?php 
                $no_admin_access = ( isset( $bp_wcv_options['redirects']['no_admin_access'] ) ? $bp_wcv_options['redirects']['no_admin_access'] : 0 );
                ?>
                                    <p><input name='bp_wcv_options[redirects][no_admin_access]' type='checkbox'
                                              value='1' <?php 
                checked( $no_admin_access, 1 );
                ?> /> <b>Turn off the
                                            redirect and
                            ...
                            <tr>
                                ...
                                <td>
									...
									<?php 
                $redirect_vendor_store_to_profil = ( isset( $bp_wcv_options['redirects']['redirect_vendor_store_to_profil'] ) ? $bp_wcv_options['redirects']['redirect_vendor_store_to_profil'] : 0 );
                ?>
                                    <p><input name='bp_wcv_options[redirects][redirect_vendor_store_to_profil]'
                                              type='checkbox'
                                              value='1' <?php 
                checked( $redirect_vendor_store_to_profil, 1 );
                ?> /> <b>Redirect
